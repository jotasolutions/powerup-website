...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap hover:cursor-pointer text-sm  transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive shadow-[inset_0_1px_0_rgba(255,255,255,0.2),inset_0_-1px_0_rgba(0,0,0,0.1),0_1px_2px_rgba(0,0,0,0.1),0_2px_4px_rgba(0,0,0,0.06)] active:brightness-95 h-9 px-4 py-2   gap-2",
  {
    variants: {
      variant: {
